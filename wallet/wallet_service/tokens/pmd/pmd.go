...
//
// Solidity: function totalSupplied() constant returns(uint256)
func (_Token *TokenCaller) TotalSupplied(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Token.contract.Call(opts, out, "totalSupplied")
	return *ret0, err
}
...
//
// Solidity: function totalSupplied() constant returns(uint256)
func (_Token *TokenSession) TotalSupplied() (*big.Int, error) {
	return _Token.Contract.TotalSupplied(&_Token.CallOpts)
}

// TotalSupplied is a free data retrieval call binding the contract method 0x630fd0ac.
//
// Solidity: function totalSupplied() constant returns(uint256)
func (_Token *TokenCallerSession) TotalSupplied() (*big.Int, error) {
	return _Token.Contract.TotalSupplied(&_Token.CallOpts)
}
